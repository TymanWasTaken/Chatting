...
class ChatScreen(
    ...
    private val chatMessages = BasicState("""
        Hello there
        
        General kenobi
    """.trimIndent())
    val chatBox = UIWrappedText().bindText(chatMessages).constrain {
        ...
        height = Config.chatHeight.orDefault { (mc.options.chatHeightFocused * 180).toInt() }.pixels()
    } childOf this.window
}